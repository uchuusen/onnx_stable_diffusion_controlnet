...
def convert_models(pipeline: StableDiffusionPipeline, output_path: str, opset: int, fp16: bool, notune: bool):
    ...
    onnx_export(
        ...
        dynamic_axes={
            ...
            "timestep": {0: "batch"},
            "encoder_hidden_states": {1: "sequence"},
            "down_block_0": {2: "height", 3: "width"},
            "down_block_1": {2: "height", 3: "width"},
            "down_block_2": {2: "height", 3: "width"},
            "down_block_3": {2: "height2", 3: "width2"},
            "down_block_4": {2: "height2", 3: "width2"},
            "down_block_5": {2: "height2", 3: "width2"},
            "down_block_6": {2: "height4", 3: "width4"},
            "down_block_7": {2: "height4", 3: "width4"},
            "down_block_8": {2: "height4", 3: "width4"},
            "down_block_9": {2: "height8", 3: "width8"},
            "down_block_10": {2: "height8", 3: "width8"},
            "down_block_11": {2: "height8", 3: "width8"},
            "mid_block_additional_residual": {2: "height8", 3: "width8"},
        },
        opset=opset,
    )
    del pipeline.unet
